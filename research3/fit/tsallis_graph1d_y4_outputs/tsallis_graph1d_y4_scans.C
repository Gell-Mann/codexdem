...
const double kNorMin = 0.03;
const double kNorMax = 6.0;
...
void tsallis_graph1d_y4_scans()
{
    ...
    TGraphAsymmErrors *gr = (TGraphAsymmErrors*)dir->Get("Graph1D_y4");
    TH1F *eStat = (TH1F*)dir->Get("Hist1D_y4_e1");
    TH1F *eSys = (TH1F*)dir->Get("Hist1D_y4_e2");

    if (!gr || !eStat || !eSys) {
        cerr << "Failed to load Graph1D_y4, Hist1D_y4_e1, or Hist1D_y4_e2" << endl;
        return;
    }
    ...
    cout << "Input: Figure 15 / Graph1D_y4" << endl;
    cout << "chi2: statistical errors from Hist1D_y4_e1" << endl;
    cout << "N(stat points) = " << nStatPoints << endl;

    resultFile << "Input: Figure 15 / Graph1D_y4\n";
    resultFile << "chi2: statistical errors from Hist1D_y4_e1\n";
