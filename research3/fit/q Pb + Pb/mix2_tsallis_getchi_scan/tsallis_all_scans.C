...
const double kNorMin = 0.05;
const double kNorMax = 5.0;
const double kQMin = 1.03;
const double kQMax = 1.13;
const double kTMin = 0.05;
const double kTMax = 0.45;
...
const string kInputFile = "mix2.root";
const string kGraphName = "Graph1D_y2";
