...
void tsafix2()
{
	...
	TGraphAsymmErrors *gr = (TGraphAsymmErrors*)td->Get("Graph1D_y2");
	
	TH1F *e1 = (TH1F*)td->Get("Hist1D_y2_e1");
	TH1F *e2 = (TH1F*)td->Get("Hist1D_y2_e2");
	...
	f1->FixParameter(0, 21.143);
     	f1->SetParameter(1, 1.120);
	f1->FixParameter(2, 0.078);
