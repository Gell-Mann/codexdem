...
void tsafix4()
{
	...
	TGraphAsymmErrors *gr = (TGraphAsymmErrors*)td->Get("Graph1D_y4");
	
	TH1F *e1 = (TH1F*)td->Get("Hist1D_y4_e1");
	TH1F *e2 = (TH1F*)td->Get("Hist1D_y4_e2");
	...
	f1->FixParameter(0, 40.185);
     	f1->SetParameter(1, 1.142);
	f1->FixParameter(2, 0.040);
