...
void tsa3()
{
	...
	constexpr const char *graphName = "Graph1D_y3";
	constexpr const char *statErrorName = "Hist1D_y3_e1plus";
	constexpr const char *sysErrorName = "Hist1D_y3_e2plus";
	...
	f1->SetParameter(0, 3.);
	f1->SetParLimits(0, 0., 2.06);
     	f1->FixParameter(1, 1.07);
	f1->SetParLimits(1, 1.091, 1.12);
	f1->SetParameter(2, 0.17);
